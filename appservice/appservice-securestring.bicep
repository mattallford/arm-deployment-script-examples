...
resource createCloudFlareCnameRecord 'Microsoft.Resources/deploymentScripts@2020-10-01' = {
  ...
  properties: {
    ...
    arguments: ' -DomainZoneName ${customDomainZoneName} -RecordType CNAME -RecordName ${customDomainRecordName} -RecordValue ${webApplication.properties.defaultHostName} -UpdateRecord'
    ...
    scriptContent: loadTextContent('New-CloudflareDnsRecordSecureString.ps1')
